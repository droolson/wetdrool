...
import { secureRandomBytes, secureRandomId } from '@socially-woke/crypto';

const HASH_DOMAIN = Buffer.from('socially-woke/auth-service/hash/v1\u0000', 'utf8');
...
export const SESSION_COOKIE_NAME = '__Host-sw-session';
export const CSRF_COOKIE_NAME = '__Host-sw-csrf';
