...
export const metadata: Metadata = {
  ...
  description: 'Inspect which replaceable WetDrool service endpoints are configured.',
};
...
const PROVIDER_COPY: Readonly<Record<ProviderSummary['id'], string>> = {
  ...
  rpc: 'Reads WetDrool program state on Solana and submits transactions. No single RPC should be required.',
  gateway:
    ...
    <div className="providers-page page-shell">
      ...
      <section className="provider-editor" aria-labelledby="provider-editor-title">
        ...
        <fieldset disabled aria-describedby="provider-editor-note">
          ...
          <input id="indexer-setting" placeholder="Managed by WETDROOL_INDEXER_URL" type="url" />
