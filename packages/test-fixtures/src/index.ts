...
export const FIXTURE_NETWORK =
  'droolnet:v1:US517G5965aydkZ46HS38QLi7UQiSojurfbQfKCELFx:YMN9Qj5jPNp7j14VPcML1B6xGgcPWVZUGLFU3Mnyfaf' as NetworkId;
export const FIXTURE_CREATED_AT = '2026-07-28T12:00:00.000Z';

const ALICE_AUTHOR = `wetdroolid:v1:${FIXTURE_NETWORK}:cGfHiC6Kgg3FpFZvgwGcswsCRtp4aBP2fzuXRQPizuN`;
const BOB_AUTHOR = `wetdroolid:v1:${FIXTURE_NETWORK}:gBxS1f6uyyGPuW5MzGBukidSb71jdsCb5fZaoSzULE5`;
