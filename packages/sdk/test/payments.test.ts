...
const network =
  'woke:v1:US517G5965aydkZ46HS38QLi7UQiSojurfbQfKCELFx:YMN9Qj5jPNp7j14VPcML1B6xGgcPWVZUGLFU3Mnyfaf';
const identityA = `swid:v1:${network}:cGfHiC6Kgg3FpFZvgwGcswsCRtp4aBP2fzuXRQPizuN`;
const identityB = `swid:v1:${network}:gBxS1f6uyyGPuW5MzGBukidSb71jdsCb5fZaoSzULE5`;
