...
const KEY_DERIVATION_DOMAIN = 'wetdrool/auth/passkey-key-wrap';
const KEY_ENVELOPE_DOMAIN = 'wetdrool/auth/account-key-bundle';
 ...
 * DroolNet's Solana-compatible transactions, so the two key roles remain
